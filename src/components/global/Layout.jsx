...
import { HomeMinor, SettingsMinor, ProductsMinor, CustomersMinor, OrdersMinor,LegalMajor } from '@shopify/polaris-icons';
...
export function MainLayout({ children }) {
    ...
    const apiUrl = 'https://app.checkoutrepublic.com'
            ...
            <Navigation.Section
                items={[
                    ...
                    },
                    {
                        ...
                        subNavigationItems: [
                            {
                              url: '/admin/abandoned-checkout',
                             onClick:()=>setLocationChange('/admin/abandoned-checkout'),
                    ...
                    },
                    {
                        ...
                        icon: LegalMajor,
                        url: '/admin/policies',
                        onClick: () => setLocationChange("/admin/policies"),
                    },
                    {
                        label: 'Settings',
                        icon: SettingsMinor,
    ...
    // const navigationMarkup = location.pathname == '/admin/store-connect' ||
    //     location.pathname == '/admin/profile/your-profile' ? NavigationMarkupSecondary : NavigationMarkupPrimary
    ...
    return (
        <div style={{ height: '500px' }}>
            {location.pathname == '/login' || location.pathname == '/sign-up'
                || location.pathname == '/sign-up-status' || location.pathname == '/reset-password'
                || location.pathname == '/change-password'
                || location.pathname == '/admin/store-connect'
                || location.pathname == '/checkout' || location.pathname == '/thank-you-page'
                || location.pathname == '/preview/checkout' || location.pathname == '/preview/thank-you-page' ?
...
function integration() {
    return (
        <svg style={{ marginTop: '4px' }} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
