...
export function Integrations() {
  ...
  const [emptyStateShow, setEmptyStateShow] = useState(false);
  const [inteActive, setInteActive] = useState();
  const [inteDraft, setInteDraft] = useState();
  ...
  const EmptyCheckCard = ({forDraft}) => {
    return (
      <>
        <Layout.Section>
          <LegacyCard sectioned>
            <EmptyState
              heading={forDraft?"No Draft integratiosn":"No Active integrations"}
  ...
  const handleEditIntegration = (variant) => {
    if (variant == "FACEBOOK_PIXEL") {
      ...
      setSelectedIntegrationId(integrationsData?.FACEBOOK_CONVERSIONS_API?.id);
      setIntegrationValue(
        JSON.parse(integrationsData?.FACEBOOK_CONVERSIONS_API?.params)
      );
    } else if (variant == "GOOGLE_ANALYTICS") {
      setSelectedIntegrationOption(3);
      setSelectedIntegrationId(integrationsData?.GOOGLE_ANALYTICS?.id);
      setIntegrationValue(
        JSON.parse(integrationsData?.GOOGLE_ANALYTICS?.params)
      );
    } else if (variant == "GOOGLE_ADS") {
      setSelectedIntegrationOption(4);
      setSelectedIntegrationId(integrationsData?.GOOGLE_ADS?.id);
      ...
      setSelectedIntegrationId(integrationsData?.GOOGLE_TAG_MANAGER?.id);
      setIntegrationValue(
        JSON.parse(integrationsData?.GOOGLE_TAG_MANAGER?.params)
      );
    } else if (variant == "KLAVIYO") {
      setSelectedIntegrationOption(6);
      setSelectedIntegrationId(integrationsData?.KLAVIYO?.id);
      ...
      setSelectedIntegrationId(integrationsData?.BING_MICROSOFT_ADS?.id);
      setIntegrationValue(
        JSON.parse(integrationsData?.BING_MICROSOFT_ADS?.params)
      );
    } else if (variant == "GOOGLE_PLACES") {
      setSelectedIntegrationOption(14);
      setSelectedIntegrationId(integrationsData?.GOOGLE_PLACES?.id);
  ...
  const getIntegrationsData = async () => {
    ...
    try {
      ...
      if (response.data.errors) {
        ...
        getIntegrationValue(response.data?.data?.data);
        setInteDraft(response.data?.data?.status?.draft);
        setInteActive(response.data?.data?.status?.active);
        let res = response.data?.data?.data?.find((item) => item?.isEnabled == 0);
        // if (res) {
  ...
  const handleEnableIntegration = async (id, value) => {
    ...
    try {
      const response = await axios.put(
        `${apiUrl}/api/integration/${id}/update`,
        data,
        {
          headers: { Authorization: `Bearer ${getAccessToken()}` },
        }
  ...
  const updateIntegration = async () => {
    ...
    try {
      const response = await axios.put(
        `${apiUrl}/api/integration/${selectedIntegrationId}/update`,
        data,
        {
          headers: { Authorization: `Bearer ${getAccessToken()}` },
        }
  ...
  const disableIntegration = async () => {
    ...
    try {
      const response = await axios.delete(
        `${apiUrl}/api/integration/${selectedIntegrationId}/delete`,
        {
          headers: { Authorization: `Bearer ${getAccessToken()}` },
        }
      );
                  ...
                  logo={
                    ...
                    >
                      ...
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M11 21.5586C11 26.7789 14.7914 31.1197 19.75 32V24.4164H17.125V21.5H19.75V19.1664C19.75 16.5414 21.4414 15.0836 23.8336 15.0836C24.5914 15.0836 25.4086 15.2 26.1664 15.3164V18H24.825C23.5414 18 23.25 18.6414 23.25 19.4586V21.5H26.05L25.5836 24.4164H23.25V32C28.2086 31.1197 32 26.7798 32 21.5586C32 15.7513 27.275 11 21.5 11C15.725 11 11 15.7513 11 21.5586Z"
                        fill="white"
                      />
                    </svg>
                  }
                ...
                <Content
                  ...
                  logo={
                    ...
                    >
                      ...
                      <path
                        d="M30.2634 11H26.4741C25.5509 11 24.793 11.7579 24.793 12.6811V31.9445H30.2634C31.1866 31.9445 31.9445 31.1867 31.9445 30.2635V12.6811C31.9445 11.758 31.1866 11 30.2634 11Z"
                        fill="#F57C00"
                      />
                      <path
                        d="M17.6141 19.2675V24.7792H12.6535C11.7441 24.7793 11 25.5234 11 26.4329V30.291C11 31.2005 11.744 31.9445 12.6535 31.9445H24.7794V17.614H19.2676C18.3581 17.614 17.6141 18.358 17.6141 19.2675Z"
                        fill="#FFC107"
                      />
                      <path
                        d="M24.7793 17.614V31.9445H30.2497C31.1729 31.9445 31.9308 31.1866 31.9308 30.2634V24.7792L24.7793 17.614Z"
                  ...
                  logo={
                    ...
                    >
                      ...
                      <g clipPath="url(#clip0)">
                        <path
                          d="M11.4826 25.6503L18.4546 13.7144C19.3402 14.2357 23.806 16.7072 24.5272 17.1772L17.5552 29.1138C16.7928 30.1212 10.5166 27.179 11.4826 25.6497V25.6503V25.6503Z"
                          fill="#FBBC04"
                        />
                        <path
                          d="M31.5149 25.6502L24.5429 13.7149C23.5683 12.0929 21.4691 11.5034 19.7449 12.4614C18.0206 13.4195 17.4956 15.4832 18.4703 17.1777L25.4423 29.1144C26.417 30.7358 28.5163 31.3252 30.2405 30.3672C31.8893 29.4091 32.4896 27.2722 31.5149 25.6516V25.6502V25.6502Z"
                          fill="#4285F4"
                        />
                        <path
                          d="M14.4998 30.8283C16.4327 30.8283 17.9996 29.3004 17.9996 27.4155C17.9996 25.5307 16.4327 24.0027 14.4998 24.0027C12.5669 24.0027 11 25.5307 11 27.4155C11 29.3004 12.5669 30.8283 14.4998 30.8283Z"
                          fill="#34A853"
                        />
                      </g>
                      <defs>
            ...
            case 6:
              return (
                <Content
                  ...
                  logo={<img src={klaviyoLogo} alt="klaviyoLogo" />}
                />
              );
                ...
                <Content
                  ...
                  logo={
                    ...
                    >
                      ...
                      <g clipPath="url(#clip0)">
                        <path
                          d="M15.4403 15.2692C13.7365 15.261 13.5001 16.9159 13.4919 18.1632C13.4838 19.4105 13.7039 21.0898 15.4077 21.1061C17.1115 21.1143 17.3479 19.4349 17.3561 18.1877C17.3642 16.9404 17.1441 15.2773 15.4403 15.2692ZM15.3914 24.3752C10.9648 24.3425 8.9838 21.4078 9.0001 18.1387C9.0164 14.8697 11.03 11.9757 15.4566 12.0002C19.8833 12.0246 21.8642 14.9431 21.8479 18.2121C21.8316 21.4811 19.818 24.3996 15.3914 24.3752Z"
                          fill="white"
                        />
                        <path
                          d="M26.5925 15.2692C24.8968 15.261 24.6604 16.9159 24.6522 18.1632C24.6441 19.4105 24.8642 21.0898 26.568 21.1061C28.2718 21.1143 28.5082 19.4349 28.5164 18.1877C28.5164 16.9404 28.2963 15.2773 26.5925 15.2692ZM26.5436 24.3752C22.1169 24.3507 20.1359 21.4078 20.1604 18.1387C20.1767 14.8697 22.1903 11.9757 26.6169 12.0002C31.0436 12.0246 33.0245 14.9431 33.0082 18.2121C32.9838 21.4811 30.9702 24.3996 26.5436 24.3752Z"
                          fill="white"
                        />
                        <path
                          d="M10.6879 24.3755C13.8754 25.8021 17.1933 26.438 20.7966 26.4543C24.5874 26.4787 27.4651 25.7614 31.1009 24.3755L31.0765 28.3048C27.8156 29.919 24.2857 30.7912 20.764 30.7668C16.9243 30.7423 14.1607 29.9597 10.6553 28.3048L10.6879 24.3755Z"
                          fill="white"
                        />
                      </g>
                      <defs>
            ...
            case 13:
              return (
                <Content
                  ...
                  desc="Ads Tracking"
                  logo={<img src={bingLogo} alt="bingLogo" />}
                />
              );
                  ...
                  logo={
                    ...
                    >
                      <g clipPath="url(#clip0_929_249)">
                        <path
                          d="M399.883 0H0.117188C0.0524666 0 0 0.0524666 0 0.117188V399.883C0 399.948 0.0524666 400 0.117188 400H399.883C399.948 400 400 399.948 400 399.883V0.117188C400 0.0524666 399.948 0 399.883 0Z"
                          fill="white"
                        />
                        ...
                        />
                        <path
                          d="M136.719 135.156H175.781C175.386 144.807 171.937 154.018 166.009 161.252C160.082 168.486 152.035 173.304 143.214 174.9C134.393 176.497 125.331 174.776 117.544 170.025C109.756 165.274 103.714 157.78 100.427 148.796C97.1407 139.812 96.8081 129.882 99.4853 120.665C102.163 111.449 107.687 103.503 115.137 98.1566C122.586 92.8102 131.509 90.3867 140.414 91.291C149.319 92.1953 157.667 96.3726 164.062 103.125"
                          stroke="#F2F2F2"
                          strokeWidth="22"
                        />
                        <path
                          d="M275.781 66.4062C275.781 51.9022 281.543 37.9922 291.799 27.7363C302.055 17.4805 315.965 11.7188 330.469 11.7188C344.973 11.7188 358.883 17.4805 369.139 27.7363C379.395 37.9922 385.156 51.9022 385.156 66.4062C385.156 121.094 330.469 121.094 330.469 189.062C330.469 121.094 275.781 121.094 275.781 66.4062Z"
                          fill="#DE3738"
                        />
                        <path
                          d="M330.469 89.0625C341.256 89.0625 350 80.3181 350 69.5312C350 58.7444 341.256 50 330.469 50C319.682 50 310.938 58.7444 310.938 69.5312C310.938 80.3181 319.682 89.0625 330.469 89.0625Z"
                          fill="#7D2426"
                        />
                      </g>
                      <defs>
            ...
            case 15:
              return (
                <Content
                  ...
                  logo={<img src={hotjarLogo} alt="hotjarLogo" />}
                />
              );
            ...
            case 16:
              return (
                <Content
                  ...
                  logo={<img src={trackifyLogo} alt="trackifyLogo" />}
                />
              );
            ...
            case 17:
              return (
                <Content
                  title="SMSBump"
                  desc="SMS Sender"
                  logo={<img src={SMSBumpLogo} alt="SMSBumpLogo" />}
                />
              );
            ...
            case 18:
              return (
                <Content
                  title="Omnisend"
                  desc="Email & SMS Sender"
                  logo={<img src={omnisendLogo} alt="omnisendLogo" />}
                />
              );
            ...
            case 19:
              return (
                <Content
                  title="Reddit"
                  desc="Ads Tracking"
                  logo={<img src={redditLogo} alt="redditLogo" />}
                />
              );
            ...
            case 20:
              return (
                <Content
                  title="Quora"
                  desc="Ads Trackingr"
                  logo={<img src={quoraLogo} alt="quoraLogo" />}
                />
              );
  ...
  return (
    <div className="Integrations-Page">
        ...
        <Form onSubmit={updateIntegration}>
          <div className="Sheet-Container Payment-Sheet">
            <div className="Sheet-Header">
              ...
              {/* <Button>
                <a
                  // href="https://help.checkify.pro/en/articles/5405170-understanding-cash-on-delivery-cod"
                  target="_blank"
            ...
            <Scrollable className="Sheet-Scrollable">
              <FormLayout>
                <span className="VisuallyHidden">
                  <Button submit id="updateIntegration">
                    Submit
                  </Button>
                </span>
                          ...
                          <>
                            <span>
                              <Text
                                ...
                                color="subdued"
                              >
                                To connect Facebook via Conversion API please
                                assign your Pixel to the system user and
                        ...
                        return (
                          <>
                            ...
                            <InputField
                              ...
                              value={
                                integrationValue.FACEBOOK_CONVERSIONS_API__ACCESS_Token
                              }
                              onChange={handleIntegrationValue}
                              required
                              autoComplete="off"
                            ...
                            <InputField
                              ...
                              value={
                                integrationValue.FACEBOOK_CONVERSIONS_API__PIXEL_ID
                              }
                              onChange={handleIntegrationValue}
                              required
                              autoComplete="off"
                          ...
                          <>
                            <span>
                              <Text
                                ...
                                color="subdued"
                              >
                                {`To integrate Google Analytics please go to your GA account > Settings (Admin tab) > Property Settings > Tracking ID or Measurement ID (GA4). `}{" "}
                          ...
                          <>
                            <span>
                              <Text
                                ...
                                color="subdued"
                              >
                                {`To find your Conversion ID and Conversion labels please go to your Google Ads admin panel > Tools and Settings > Measurement > Conversions. `}{" "}
                            ...
                            <InputField
                              ...
                              value={
                                integrationValue.GOOGLE_ADS__CHECKOUT_LABEL
                              }
                              onChange={handleIntegrationValue}
                              autoComplete="off"
                              required
                            ...
                            <InputField
                              ...
                              value={
                                integrationValue.GOOGLE_ADS__PURCHASE_LABEL
                              }
                              onChange={handleIntegrationValue}
                              autoComplete="off"
                              required
                          ...
                          <>
                            <span>
                              <Text
                                ...
                                color="subdued"
                              >
                                {`To connect your Google Tag Manager please visit your admin panel and copy GTM ID from the top bar.`}
                                {"  "}
                          ...
                          <>
                            <span>
                              <Text
                                ...
                                color="subdued"
                              >
                                {`To activate Klaviyo integration you should create a Public API Key from your Klaviyo admin panel. Just go to Klaviyo > Account >Settings > API Keys > Public API Key. `}
                                {"  "}
                          ...
                          <>
                            <span>
                              <Text
                                ...
                                color="subdued"
                              >
                                {`You can find your TikTok Pixel ID in TikTok Ads Manager > Assets > Event > Website Pixel > Manage. `}
                          ...
                          <>
                            <span>
                              <Text
                                ...
                                color="subdued"
                              >
                                {`You can find your Pinterest Tag ID in Pinterest Ads Manager > Ads > Conversions > Add code to website (Tag ID will be displayed in the right upper corner).`}
                                {""}
                          ...
                          <>
                            <span>
                              <Text
                                ...
                                color="subdued"
                              >
                                {`You can find your Snap Pixel ID in Snapchat Ads Manager > Assets > Snap Pixel > Manage Pixel > Setup Pixel.`}
                          ...
                          <>
                            <span>
                              <Text
                                ...
                                color="subdued"
                              >
                                {`You can find your Website Tag ID in Twitter Ads > Tools > Conversion Tracking > (Tag ID will be displayed on the Purchase conversion event, right under its name). `}
                                {"  "}
                          ...
                          <>
                            <span>
                              <Text
                                ...
                                color="subdued"
                              >
                                {`You can find your Account ID at the end of the URL (website address) when in your Backstage account (https://backstage.taboola.com/backstage/XXXXXX). `}
                          ...
                          <>
                            <span>
                              <Text
                                ...
                                color="subdued"
                              >
                                {`You can find your Pixel ID in Conversions > Outbrain Pixel (Pixel ID will be displayed as a value of OB_ADV_ID variable). `}
                                {"  "}
                          ...
                          <>
                            <span>
                              <Text
                                ...
                                color="subdued"
                              >
                                {`You can find your Bing Tag in Conversions Tracking > UET Tag (ID will be shown when you click 'View tag' or generate new one).`}
                          ...
                          <>
                            <span>
                              <Text
                                ...
                                color="subdued"
                              >
                                {`You can find your Google API key in Your project > Credentials (click Show Key in section API Keys or generate new one).`}
                          ...
                          <>
                            <span>
                              <Text
                                ...
                                color="subdued"
                              >
                                {`You could find the Site ID when you go to Settings menu > Sites & Organizations list > Get ID of the site you want.`}
                          ...
                          <>
                            <span>
                              <Text
                                ...
                                color="subdued"
                              >
                                {`You need to have Trackify installed on your store in order for this integration to work.  `}
                          ...
                          <>
                            <span>
                              <Text
                                ...
                                color="subdued"
                              >
                                {`To activate SMSBump integration you should take your API Credentials and List ID from your SMSBump account.`}
                          ...
                          <>
                            <span>
                              <Text
                                ...
                                color="subdued"
                              >
                                {`To activate Omnisend integration you should take your API Key from your Omnisend account.`}
                          ...
                          <>
                            <span>
                              <Text
                                ...
                                color="subdued"
                              >
                                {`To activate Reddit integration you should take your Advertiser ID from your Reddit Ad account. `}
                                {"  "}
                          ...
                          <>
                            <span>
                              <Text
                                ...
                                color="subdued"
                              >
                                {`To activate Quora integration you should take your Quora Pixel ID from your Quora Ad account.`}
                                {"  "}
                          ...
                          <>
                            <span>
                              <Text
                                ...
                                color="subdued"
                              >
                                {`To activate Postscript integration you should take your Private Key and Keyword from your Postscript account.`}
                                {"  "}
      ...
      <Page
        ...
        //   <ButtonGroup>
        //     <a
        //       // href="https://help.checkify.pro/en/articles/4367163-general-customization-settings"
        //       target="_blank"
        //     >
        //       <Button>
        //         Explore the guide <Icon source={ExternalMinor}></Icon>
        //       </Button>
        //     </a>
        //   </ButtonGroup>
        // }
            ...
            <>
              <div className="Integrations-Tab">
                {!integrationBanner && (
                  ...
                  >
                    <p>
                      Some third-party eCom apps that are widely used with
                      Shopify require data from the checkout page.
                    </p>
                    <p>
                      To continue using your favorite applications, set up their
                      integration with Checkout Republic here.
                    </p>
                  </Banner>
                )}
                ...
                <Layout>
                     {selectedTab==1 && inteActive == 0 && <EmptyCheckCard/>}
                     {selectedTab==2 && inteDraft == 0 && <EmptyCheckCard forDraft/>}
                  {selectedTab == 0 ||
                  selectedTab ==
                    (integrationsData?.FACEBOOK_PIXEL?.isEnabled == 1
                      ? 1
                      : 2) ? (
                            ...
                            : [
                                {
                                  ...
                                  onAction: () =>
                                    handleEditIntegration("FACEBOOK_PIXEL"),
                                },
                              ]
                        }
                      >
                        ...
                        <div className="Card-Description">
                          <Text variant="bodyMd" as="p">
                            Facebook Pixel is a basic tool for tracking
                            conversions coming from Facebook Ads.
                          </Text>
                        </div>
                        ...
                        <div className="Card-Active">
                          {integrationsData?.FACEBOOK_PIXEL?.params == null ? (
                            <Button
                              primary
                              onClick={() =>
                                handleConnectIntegration("FACEBOOK_PIXEL")
                              }
                            >
                              Connect
                            </Button>
                            ...
                            <>
                              <span>
                                <input
                                  ...
                                  checked={convertNumberToBoolean(
                                    integrationsData?.FACEBOOK_PIXEL?.isEnabled
                                  )}
                                  onChange={() =>
                                    handleEnableIntegration(
                                      integrationsData?.FACEBOOK_PIXEL?.id,
                                      integrationsData?.FACEBOOK_PIXEL
                                        ?.isEnabled
                                    )
                                  }
                                />
                                <label
                                  htmlFor={integrationsData?.FACEBOOK_PIXEL?.id}
                                  className="tgl-btn"
                                ></label>
                              </span>
                  ...
                  {selectedTab == 0 ||
                  selectedTab ==
                    (integrationsData?.GOOGLE_ANALYTICS?.isEnabled == 1
                      ? 1
                      : 2) ||
                  selectedTab == 4 ? (
                    <Layout.Section oneThird>
                            ...
                            : [
                                {
                                  ...
                                  onAction: () =>
                                    handleEditIntegration("GOOGLE_ANALYTICS"),
                                },
                              ]
                        }
                      >
                        ...
                        <div className="Card-Description">
                          <Text variant="bodyMd" as="p">
                            Gather visitors insights and measures your
                            conversions rate.
                          </Text>
                        </div>

                        <div className="Card-Active">
                          {integrationsData?.GOOGLE_ANALYTICS?.params ==
                          null ? (
                            <Button
                              primary
                              onClick={() =>
                                handleConnectIntegration("GOOGLE_ANALYTICS")
                              }
                            >
                              Connect
                            </Button>
                            ...
                            <>
                              <span>
                                <input
                                  ...
                                  className="tgl tgl-light"
                                  checked={convertNumberToBoolean(
                                    integrationsData?.GOOGLE_ANALYTICS
                                      ?.isEnabled
                                  )}
                                  onChange={() =>
                                    handleEnableIntegration(
                                      integrationsData?.GOOGLE_ANALYTICS?.id,
                                      integrationsData?.GOOGLE_ANALYTICS
                                        ?.isEnabled
                                    )
                                  }
                  ...
                  {selectedTab == 0 ||
                  selectedTab ==
                    (integrationsData?.GOOGLE_ADS?.isEnabled == 1 ? 1 : 2) ||
                  selectedTab == 2 ? (
                    <Layout.Section oneThird>
                      <Card
                        sectioned
                            ...
                            : [
                                {
                                  ...
                                  onAction: () =>
                                    handleEditIntegration("GOOGLE_ADS"),
                                },
                              ]
                        }
                      >
                        ...
                        <div className="Card-Description">
                          <Text variant="bodyMd" as="p">
                            Setup conversion events and monitor conversions
                        ...
                        <div className="Card-Active">
                          {integrationsData?.GOOGLE_ADS?.params == null ? (
                            <Button
                              primary
                              onClick={() =>
                                handleConnectIntegration("GOOGLE_ADS")
                              }
                            >
                              Connect
                            </Button>
                            ...
                            <>
                              <span>
                                <input
                                  ...
                                  className="tgl tgl-light"
                                  checked={convertNumberToBoolean(
                                    integrationsData?.GOOGLE_ADS?.isEnabled
                                  )}
                                  onChange={() =>
                                    handleEnableIntegration(
                                      integrationsData?.GOOGLE_ADS?.id,
                                      integrationsData?.GOOGLE_ADS?.isEnabled
                                    )
                                  }
                                />
                                <label
                                  htmlFor={integrationsData?.GOOGLE_ADS?.id}
                                  className="tgl-btn"
                                ></label>
                              </span>
                              <Text variant="bodyMd" as="p" fontWeight="medium">
                  ...
                  {selectedTab == 0 ||
                  selectedTab ==
                    (integrationsData?.GOOGLE_TAG_MANAGER?.isEnabled == 1
                      ? 1
                      : 2) ? (
                    <Layout.Section oneThird>
                      <Card
                            ...
                            : [
                                {
                                  ...
                                  onAction: () =>
                                    handleEditIntegration("GOOGLE_TAG_MANAGER"),
                                },
                              ]
                        }
                      >
                          ...
                          <span>
                            ...
                            >
                              ...
                              <g clipPath="url(#clip0)">
                                ...
                                >
                                  <path
                                    d="M31.5795 20.4859L22.5139 11.4203C21.9533 10.8596 21.0467 10.8596 20.4861 11.4203L11.4205 20.4859C10.8598 21.0465 10.8598 21.9531 11.4205 22.5137L20.4861 31.5793C21.0467 32.14 21.9533 32.14 22.5139 31.5793L31.5795 22.5137C32.1402 21.9531 32.1402 21.0465 31.5795 20.4859V20.4859ZM21.5 23.8855L19.1143 21.4998L21.5 19.1141L23.8857 21.4998L21.5 23.8855Z"
                                    fill="white"
                                  />
                                </mask>
                                <g mask="url(#mask0)">
                                  <path
                                    d="M31.5557 20.4974L28.2263 17.1681L25.8482 14.79L21.508 19.1301L23.8862 21.5082L21.5081 23.8862L17.168 28.2264L20.4974 31.5558C21.0562 32.1146 21.9599 32.1146 22.5187 31.5558L25.8481 28.2264L28.2262 25.8483L31.5556 22.5189C32.1145 21.9601 32.1145 21.0563 31.5556 20.4974H31.5557Z"
                                    fill="#4285F4"
                                  />
                                  <path
                                    d="M25.8478 14.79L22.5184 11.4606C21.9596 10.9018 21.0559 10.9018 20.4971 11.4606L17.1677 14.79L14.7896 17.1681L11.4601 20.4975C10.9013 21.0564 10.9013 21.9601 11.4601 22.5189L14.7895 25.8483L17.1676 28.2264L21.5077 23.8864L19.1296 21.5083L21.5077 19.1301L25.8478 14.79V14.79Z"
                                    fill="#4FC3F7"
                                  />
                                  <mask
                                    id="mask1"
                                  ...
                                  <g mask="url(#mask2)">
                                    <path
                                      opacity="0.2"
                                      d="M31.5551 22.4L22.5181 31.4369C21.9593 31.9957 21.0555 31.9957 20.4967 31.4369L11.4599 22.4C11.1983 22.1383 11.0556 21.7935 11.0437 21.4487C11.0318 21.8292 11.1627 22.2216 11.4599 22.5188L20.4968 31.5557C21.0556 32.1146 21.9594 32.1146 22.5182 31.5557L31.5551 22.5188C31.8524 22.2216 31.9833 21.8411 31.9714 21.4487C31.9595 21.7935 31.8167 22.1384 31.5551 22.4Z"
                                      fill="#1A237E"
                                    />
                                  </g>
                                  <mask
                                  ...
                                  <g mask="url(#mask3)">
                                    <path
                                      d="M21.508 23.8863L17.168 28.2263L20.4974 31.5557C21.0562 32.1145 21.9599 32.1145 22.5187 31.5557L25.8481 28.2263L21.508 23.8862V23.8863Z"
                                      fill="url(#paint0_linear)"
                                    />
                                    <path
                                      d="M31.5554 20.4975L22.5183 11.4606C21.9595 10.9018 21.0558 10.9018 20.497 11.4606L11.4601 20.4975C10.9013 21.0564 10.9013 21.9601 11.4601 22.5189L20.4971 31.5558C21.0559 32.1147 21.9596 32.1147 22.5184 31.5558L31.5554 22.5189C32.1143 21.9601 32.1143 21.0564 31.5554 20.4975ZM21.5077 23.8864L19.1296 21.5083L21.5077 19.1301L23.8859 21.5082L21.5078 23.8863L21.5077 23.8864Z"
                                    ...
                                    />
                                    <path
                                      d="M21.5482 23.9058L23.3739 25.7289L18.8736 29.9104L17.209 28.2458L21.5482 23.9058Z"
                                      fill="url(#paint2_linear)"
                                      fillOpacity="0.8"
                                    />
                                    <path
                                      d="M25.847 14.8115L27.6728 16.6346L23.1724 20.8161L21.5078 19.1515L25.847 14.8115Z"
                        ...
                        <div className="Card-Description">
                          <Text variant="bodyMd" as="p">
                            Manage and deploy marketing tags on your website
                            without code modifying.
                          </Text>
                        </div>

                        <div className="Card-Active">
                          {integrationsData?.GOOGLE_TAG_MANAGER?.params ==
                          null ? (
                            <Button
                              primary
                              onClick={() =>
                                handleConnectIntegration("GOOGLE_TAG_MANAGER")
                              }
                            >
                              Connect
                            </Button>
                            ...
                            <>
                              <span>
                                <input
                                  ...
                                  className="tgl tgl-light"
                                  checked={convertNumberToBoolean(
                                    integrationsData?.GOOGLE_TAG_MANAGER
                                      ?.isEnabled
                                  )}
                                  onChange={() =>
                                    handleEnableIntegration(
                                      integrationsData?.GOOGLE_TAG_MANAGER?.id,
                                      integrationsData?.GOOGLE_TAG_MANAGER
                                        ?.isEnabled
                                    )
                                  }
                  ...
                  {selectedTab == 0 ||
                  selectedTab ==
                    (integrationsData?.TIKTOK?.isEnabled == 1 ? 1 : 2) ? (
                    <Layout.Section oneThird>
                      <Card
                        sectioned
                        actions={
                      ...
                      >
                        ...
                        <div className="Card-Description">
                          <Text variant="bodyMd" as="p">
                            Add TikTok Pixel to track the performance of your
                            TikTok ads.
                          </Text>
                        </div>
                            ...
                            <>
                              <span>
                                <input
                                  ...
                                  className="tgl tgl-light"
                                  checked={convertNumberToBoolean(
                                    integrationsData?.TIKTOK?.isEnabled
                                  )}
                                  onChange={() =>
                                    handleEnableIntegration(
                                      integrationsData?.TIKTOK?.id,
                                      integrationsData?.TIKTOK?.isEnabled
                                    )
                                  }
                                />
                                <label
                                  htmlFor={integrationsData?.TIKTOK?.id}
                                  className="tgl-btn"
                                ></label>
                              </span>
                              <Text variant="bodyMd" as="p" fontWeight="medium">
                  ...
                  {selectedTab == 0 ||
                  selectedTab ==
                    (integrationsData?.PINTEREST?.isEnabled == 1 ? 1 : 2) ? (
                    <Layout.Section oneThird>
                      <Card
                        sectioned
                        actions={
                            ...
                            : [
                                {
                                  ...
                                  onAction: () =>
                                    handleEditIntegration("PINTEREST"),
                                },
                              ]
                        }
                      >
                        ...
                        <div className="Card-Description">
                          <Text variant="bodyMd" as="p">
                            Use Pinterest Ads Tag to measure performance of your
                            Pinterest ads.
                          </Text>
                        </div>
                        ...
                        <div className="Card-Active">
                          {integrationsData?.PINTEREST?.params == null ? (
                            <Button
                              primary
                              onClick={() =>
                                handleConnectIntegration("PINTEREST")
                              }
                            >
                              Connect
                            </Button>
                            ...
                            <>
                              <span>
                                <input
                                  ...
                                  className="tgl tgl-light"
                                  checked={convertNumberToBoolean(
                                    integrationsData?.PINTEREST?.isEnabled
                                  )}
                                  onChange={() =>
                                    handleEnableIntegration(
                                      integrationsData?.PINTEREST?.id,
                                      integrationsData?.PINTEREST?.isEnabled
                                    )
                                  }
                                />
                                <label
                                  htmlFor={integrationsData?.PINTEREST?.id}
                                  className="tgl-btn"
                                ></label>
                              </span>
                              <Text variant="bodyMd" as="p" fontWeight="medium">
                  ...
                  {selectedTab == 0 ||
                  selectedTab ==
                    (integrationsData?.SNAPCHAT?.isEnabled == 1 ? 1 : 2) ? (
                    <Layout.Section oneThird>
                      <Card
                        sectioned
                        actions={
                            ...
                            : [
                                {
                                  ...
                                  onAction: () =>
                                    handleEditIntegration("SNAPCHAT"),
                                },
                              ]
                        }
                      >
                        ...
                        <div className="Card-Description">
                          <Text variant="bodyMd" as="p">
                            Activate Snap Pixel to track conversions coming from
                            Snapchat Ads.
                          </Text>
                        </div>
                        ...
                        <div className="Card-Active">
                          {integrationsData?.SNAPCHAT?.params == null ? (
                            <Button
                              primary
                              onClick={() =>
                                handleConnectIntegration("SNAPCHAT")
                              }
                            >
                              Connect
                            </Button>
                            ...
                            <>
                              <span>
                                <input
                                  ...
                                  className="tgl tgl-light"
                                  checked={convertNumberToBoolean(
                                    integrationsData?.SNAPCHAT?.isEnabled
                                  )}
                                  onChange={() =>
                                    handleEnableIntegration(
                                      integrationsData?.SNAPCHAT?.id,
                                      integrationsData?.SNAPCHAT?.isEnabled
                                    )
                                  }
                                />
                                <label
                                  htmlFor={integrationsData?.SNAPCHAT?.id}
                                  className="tgl-btn"
                                ></label>
                              </span>
                              <Text variant="bodyMd" as="p" fontWeight="medium">
                  ...
                  {selectedTab == 0 ||
                  selectedTab ==
                    (integrationsData?.TWITTER?.isEnabled == 1 ? 1 : 2) ? (
                    <Layout.Section oneThird>
                      <Card
                        sectioned
                        actions={
                      ...
                      >
                        ...
                        <div className="Card-Description">
                          <Text variant="bodyMd" as="p">
                            Link your Twitter Ads account and track purchases
                        ...
                        <div className="Card-Active">
                          {integrationsData?.TWITTER?.params == null ? (
                            <Button
                              primary
                              onClick={() =>
                                handleConnectIntegration("TWITTER")
                              }
                            >
                              Connect
                            </Button>
                            ...
                            <>
                              <span>
                                <input
                                  ...
                                  className="tgl tgl-light"
                                  checked={convertNumberToBoolean(
                                    integrationsData?.TWITTER?.isEnabled
                                  )}
                                  onChange={() =>
                                    handleEnableIntegration(
                                      integrationsData?.TWITTER?.id,
                                      integrationsData?.TWITTER?.isEnabled
                                    )
                                  }
                                />
                                <label
                                  htmlFor={integrationsData?.TWITTER?.id}
                                  className="tgl-btn"
                                ></label>
                              </span>
                              <Text variant="bodyMd" as="p" fontWeight="medium">
