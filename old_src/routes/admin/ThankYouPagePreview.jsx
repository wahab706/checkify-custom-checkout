                                    ...
                                    <Stack>
                                        ...
                                        <div className='Order-Product-Detail-Section'>
                                            ...
                                            <span className='Product-Extras'>
                                                ...
                                                <a href={item.buttonUrl ? item.buttonUrl : `https://ecommercehack.com/login`}
                                                    target="_blank"
                ...
                <div className='Order-Product-Detail-Section'>
                    <Card sectioned>
                        <Stack>
                            ...
                            <div>
                                <p className='Content'>Ahmad Naeem</p>
                                <p className='Content'>ahmad@webinopoly.com</p>
                                <p className='Content'>United States</p>
                                <p className='Content'>Street No 5</p>
                                <p className='Content'>NewYork, 45000</p>
                            </div>
                        </Stack>
